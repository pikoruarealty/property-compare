          ...
          >
            <div className="relative aspect-[16/10] overflow-hidden sm:aspect-[16/7]">
              ...
              <div className="absolute bottom-3 left-3 right-3">
                <span className="glass rounded-full px-3 py-1 text-[10px] tracking-luxury text-champagne">
                  {p.status}
                </span>
              </div>
            </div>
            <div className="p-4">
              <h3 className="truncate font-display text-base text-ivory sm:text-lg">{p.name}</h3>
